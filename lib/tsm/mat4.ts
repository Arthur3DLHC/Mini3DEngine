...
export default class mat4 {
    ...
    fromScaling(scaling: vec3): mat4 {
        this.values[0] = scaling.x;
        this.values[1] = 0;
        this.values[2] = 0;
        this.values[3] = 0;
        this.values[4] = 0;
        this.values[5] = scaling.y;
        this.values[6] = 0;
        this.values[7] = 0;
        this.values[8] = 0;
        this.values[9] = 0;
        this.values[10] = scaling.z;
        this.values[11] = 0;
        this.values[12] = 0;
        this.values[13] = 0;
        this.values[14] = 0;
    ...
    fromRotation(rad: number, axis: vec3): mat4 | null {
        ...
        this.values[0] = x * x * t + c;
        this.values[1] = y * x * t + z * s;
        this.values[2] = z * x * t - y * s;
        this.values[3] = 0;
        this.values[4] = x * y * t - z * s;
        this.values[5] = y * y * t + c;
        this.values[6] = z * y * t + x * s;
        this.values[7] = 0;
        this.values[8] = x * z * t + y * s;
        this.values[9] = y * z * t - x * s;
        this.values[10] = z * z * t + c;
        this.values[11] = 0;
        this.values[12] = 0;
        this.values[13] = 0;
        this.values[14] = 0;
    ...
    getTranslation(out: vec3): vec3 {
        out.x = this.values[12];
        out.y = this.values[13];
        out.z = this.values[14];
        return out;
    }

    getScaling(out: vec3): vec3 {
        let m11 = this.values[0];
        let m12 = this.values[1];
        let m13 = this.values[2];
        let m21 = this.values[4];
        let m22 = this.values[5];
        let m23 = this.values[6];
        let m31 = this.values[8];
        let m32 = this.values[9];
        let m33 = this.values[10];
    ...
    getRotation(out: quat): quat {
        ...
        let sm11 = this.values[0] * is1;
        let sm12 = this.values[1] * is2;
        let sm13 = this.values[2] * is3;
        let sm21 = this.values[4] * is1;
        let sm22 = this.values[5] * is2;
        let sm23 = this.values[6] * is3;
        let sm31 = this.values[8] * is1;
        let sm32 = this.values[9] * is2;
        let sm33 = this.values[10] * is3;
    ...
    fromQuat(q: quat): mat4 {
        ...
        this.values[0] = 1 - yy - zz;
        this.values[1] = yx + wz;
        this.values[2] = zx - wy;
        this.values[3] = 0;

        this.values[4] = yx - wz;
        this.values[5] = 1 - xx - zz;
        this.values[6] = zy + wx;
        this.values[7] = 0;

        this.values[8] = zx + wy;
        this.values[9] = zy - wx;
        this.values[10] = 1 - xx - yy;
        this.values[11] = 0;
