// mostly from https://github.com/bwasty/gltf-loader-ts/blob/master/source/gltf-asset.ts

import { GlTf, GlTfId } from "./gltf.js";
...
export class GltfAsset {
    ...
    public gltf: GlTf;
    public glbData: GLTFBinaryData | undefined;
     ...
     */
    public async bufferViewData(index: GlTfId): Promise<Uint8Array> {
...
export class BufferData {
    ...
    async get(index: GlTfId): Promise<Uint8Array> {
        ...
        // gltf.buffers 中是已经将每个 buffer 的数据从总二进制数据块中拆分出来了。
...
export class ImageData {
    ...
    async get(index: GlTfId): Promise<HTMLImageElement> {
        ...
        // image maybe a remote image file or binary data in data buffer
