...
import { ColorWriteState } from "../WebGLResources/renderStates/colorWriteState.js";
...
export class RenderStateSet {
    public constructor() {
        ...
        this.colorWriteState = RenderStateCache.instance.getColorWriteState(true, true, true, true);
    }
    // todo: default render state objects for each render pass
    public blendState: BlendState;
    public cullState: CullState;
    public depthState: DepthStencilState;
    public colorWriteState: ColorWriteState;
    ...
    public apply() {
        ...
        GLRenderStates.setColorWriteState(this.colorWriteState);
    }
}